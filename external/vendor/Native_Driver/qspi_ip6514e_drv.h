...
enum qspi_ip6514e_error_t {
    ...
    QSPI_IP6514E_ERR_TRIGG_ADDR_RANGE_TOO_LOW,
    QSPI_IP6514E_ERR_MAX, /* Any new error should be added before this one */
};
...
enum qspi_ip6514e_spi_mode_t {
    QSPI_IP6514E_SPI_MODE,  /*!< Use 1 line for Instruction, Address and Data */
    QSPI_IP6514E_DSPI_MODE, /*!< Use 2 lines for Instruction, Address and
                                 Data */
    QSPI_IP6514E_QSPI_MODE, /*!< Use 4 lines for Instruction, Address and
                                 Data */
};
 ...
 * \param[out] write_data        Pointer to a memory zone where are
